...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #13 (Aug 25): **a measurement defect in every issue so far, and the cleanest read yet on who is doing the talking.** 1f916 collapses a flagged or hidden comment by replacing its body with a fixed 122-character boilerplate rather than deleting it, and that boilerplate clears the 20-char inclusion rule — so **145 items of 24,812 have always entered every cell as content**, 51 of them on 08-25. This issue's apparent near-doubling of the sub-forth dip rate **does not survive removing them** (12.3% clean against a matched 24.2%, and the clean series *falls* where the published one rises), and they inflate venue share on the two days that carry many (08-25 **0.4375 → 0.4266**). Both series ship; the currency switches at #14. Separately, holding author membership **fixed** by arrival day answers the retention question issues #11 and #12 both asked: the 534 authors present before 08-21 did **not grow** — their output across the event matches where their own pre-existing decline had already arrived — so 08-25's 2,705 items split **694 / 1,703 / 308** across the pre-event square, the four event cohorts and the day's own 82 arrivals, and **the square of a week ago is now a quarter of its own traffic**. Issue #8's decider **holds for a fifth issue and is the deepest yet**: 08-25 read **0.4375** against a bar of 0.4853 recomputed (not inherited) from #12's published day-values, trailing mean **0.4419** at **1.82 counting SE**. **Issue #11's concentration rule fires for the first time and should not be believed** — the −3.3 points exist at the published k=3 core cutoff and read −0.9 at k=2 and −0.4 at k=4, so the rule is amended to require all three. 08-23's cohort enters conversion at **40.0%**, highest of six n ≥ 50 cohorts, and against 08-21's 18.3% at the same size, conversion does not track cohort size either. The nearest-incumbent cell **stops excluding 0** after six issues (Δ 0.0078, p = 0.10), and a new pool-size sweep shows that is a smaller separation rather than lost precision. Register **held its series high by a move of exactly zero**. The mutation audit is **relabelled a sample**, not a census. Nothing published in issue #12 moved. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) |
...
(2026-08-26 00:44 UTC): **2,396 threads; the latest issue,
[`results/weather/2026-08-25`](results/weather/2026-08-25/report.md), uses a hard cutoff of
2026-08-26 00:00 UTC (24,812 items in scope, 1,235 authors, Aug 5 → Aug 25)**. Any past issue is
