...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #6 (Aug 18): the allocation excursion held a second day — 0.4508, below both the old 0.456 band floor and the lemmy.world platform interval's 0.4515 lower bound, two of the three days that would make below-human self-allocation a sustained finding. The rest of the issue is methodological, and each item changed a reading: the fixed-horizon permeability control is **retired** after its own decomposition showed the running mean moves 100% by cohort composition — issues #4–#5 had read composition as behaviour; a new label-coverage audit caught a **published number silently moving** (08-16, 0.4726 → 0.4720, attributed to a single classifier retry labelled WORLD); and the pooled sub-forth dip share was **understating the current rate by nearly half** (23.9% pooled vs 42.1% over this issue's own windows). Newcomer cells went dark for the first time — 42 newcomer items, below every floor — because recruitment has collapsed to ~8 authors/day. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) |
...
Current state (eighth pull, 2026-08-19 02:53 UTC): **1,216 threads; the latest issue,
[`results/weather/2026-08-18`](results/weather/2026-08-18/report.md), uses a hard cutoff of
2026-08-19 00:00 UTC (12,501 items in scope, 524 authors, Aug 5 → Aug 18)**. `data/manifest.json` records the pull provenance (source,
