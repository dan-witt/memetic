...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #16 (Aug 29): **a new coverage instrument found the corpus was not complete, and two pre-registered calls resolve.** Item ids on 1f916 are dense integers, so a gap in the range is a candidate missing item — and nothing the pipeline published could see one, because coverage reports what was *verified* and backfill counts what arrived *late*. The scan found **one missing comment and one missing post**, both written 08-23, both live and retrievable; `corpus_fetch.py` now runs the scan every catch-up, resolves a comment id to its thread through `/api/comment/:id`, force-fetches ahead of feed and sweep, and caches ids the API no longer serves. **In scope the corpus now holds every id the API still serves**: 0 missing comment ids across 30,845. It also showed what the instrument cannot do — post 27 was *deleted* before we first saw it, so "does not exist" cannot separate never-issued from gone. **Issue #3's placement decline arm is dead**: the window cell rose 1.170 → **1.202**, and at matched one-day width 08-29 reads **1.205**, back with 08-24…08-26 and outside 08-27's band — the step issue #15 isolated was a two-day excursion, so its refusal to complete the trigger is vindicated by data rather than argument. **The concentration cell is RETIRED** on issue #15's pre-registered trigger: k=2/3/4 disagreed in sign for a third consecutive issue. **Issue #8's decider is deeper for a fourth consecutive issue** — trailing mean **0.4245**, **5.83 counting SE** below the bound, a ninth consecutive day-endpoint, and 0.4238 over incumbents alone, so still not the arrivals. The **newcomer instrument has run out of newcomers** (542 → 144 → **95** items) and two of its three cells went dark at their floors, exactly as pre-registered. The repair moves 08-23 by two items and 303 of 785 rolling windows, so the shared-prefix assertion is suspended this issue by construction — and issues #13–#16 all still reproduce **14/14** from their own published `pull_at`, the pinning contract holding under a corpus repair for the first time. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) · [#14](results/weather/2026-08-27/report.md) · [#15](results/weather/2026-08-28/report.md) · [#16](results/weather/2026-08-29/report.md) |
...
(2026-08-30 04:54 UTC): **3,103 threads; the latest issue,
[`results/weather/2026-08-29`](results/weather/2026-08-29/report.md), uses a hard cutoff of
2026-08-30 00:00 UTC (33,591 items in scope, 1,354 authors, Aug 5 → Aug 29, excluding 206
