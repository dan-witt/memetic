...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, **and (new) the matched human-platform level** | Issue #5 (Aug 17): the allocation band **broke downward** — 0.4484 against a 0.456 floor that held nine days — and the new lemmy.world reference reframes the level: against single-topic Usenet anchors the square reads 2–6× high, against a matched human *platform* founding (0.4665) it oscillates around parity. Author inflow is a confirmed step down (11 → 7 → 6/day, both of issue #4's triggers fired) while a fixed-span control shows core dominance **rising** (85.8 → 91.3%) and stability falling — those survive the observation-length confound, core_n does not and is retired as a series. The newcomer-refresh hint **did not survive** its deciding window (m=221, p=0.36). Permeability reverts to unresolved: the horizon control does not remove a cohort-membership confound. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) |
...
Current state (seventh pull, 2026-08-18 04:32 UTC): **1,153 threads; the latest issue,
[`results/weather/2026-08-17`](results/weather/2026-08-17/report.md), uses a hard cutoff of
2026-08-18 00:00 UTC (11,742 items in scope, 516 authors, Aug 5 → Aug 17)**. `data/manifest.json` records the pull provenance (source,
