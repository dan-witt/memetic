...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #18 (Aug 31): **issue #17's record fall was one draw, and the venue axis gets a reference set the square itself defines.** The window-level median came back **+0.0058 to 0.1329**, the second-largest move the column has after issue #6's, almost exactly reversing #17's −0.0057 and clearing that issue's own "return to 0.130" test. Allocation set a record of its own: **08-31 reads 0.4019, the lowest daily venue share of 26 classified days**, and issue #8's decider fires an eleventh consecutive time at 6.03 counting SE — reported as the rule's output, not as self-attention, per #17's ruling. New this issue, `analysis/weather_venue_gold.py` builds an exact-match reference set from the square's **own published record** (`/api/official`'s complete operated-property list, official token and treasury address; `/api/surface`'s 74 routes, snapshotted to `data/1f916_own_identifiers.json`). Against a day-mix-standardised base rate the published binary shows **a lift of −0.1 points** on that set, while the frozen three-way predicate separates the same items by **33 points** — and the control of addresses the record *disowns* reads **+12 points at 4.9 SE**, higher than the square's own token. One exception runs the other way and is unexplained: a link to the square's own repositories, +17 points on 143 items. Elsewhere: **zero backfill on the largest exposure stretch the series has measured** (935 items / 8.2 h); arrivals up 11 → 13, the first rise in seven days, leaving the newcomer instrument partial (NN cell fires at 68 items, Vendi cells dark); **issue #17's pooled newcomer reading does not carry over** and is demoted to provisional — and the 68% item overlap it was judged against turns out to be the wrong overlap, since only **37%** of its newcomer items are still newcomers; placement flat for a twelfth issue with the matched-day cell oscillating in 1.152–1.219 over ten days; register back to 0.6591; the panel at 76; shared-prefix assertion holds at 0 of 889; id scan clean, 0 edits, one moderation pin. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) · [#14](results/weather/2026-08-27/report.md) · [#15](results/weather/2026-08-28/report.md) · [#16](results/weather/2026-08-29/report.md) · [#17](results/weather/2026-08-30/report.md) · [#18](results/weather/2026-08-31/report.md) |
...
(2026-09-01 02:38 UTC): **3,369 threads; the latest issue,
[`results/weather/2026-08-31`](results/weather/2026-08-31/report.md), uses a hard cutoff of
2026-09-01 00:00 UTC (37,583 items in scope, 1,378 authors, Aug 5 → Aug 31, excluding 206
moderation placeholders — see issue #14 for the currency change)**. From issue #16 every catch-up
