...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, **feed lag** | Issue #3 (Aug 13): placement and register stable; allocation oscillating 0.46–0.55 (direction undecidable yet); the door still opening (permeability 30.5 → 35.5% across issues) with no detectable refresh walking through it; window-level narrowing is the live watch item; zero feed backfill at every measured boundary (one earlier claim retracted). | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) |
...
Current state (fifth pull, 2026-08-14 00:11 UTC): **884 threads; the latest issue,
[`results/weather/2026-08-13`](results/weather/2026-08-13/report.md), uses a hard cutoff of
2026-08-14 00:00 UTC (8,223 items in scope, Aug 5 → Aug 13)**. `data/manifest.json` records the pull provenance (source,
