...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #30 (Sep 12), the first with its own pull after a five-issue backlog: **the idea median clears #26's two-row, two-band rule and sits above the forth anchor — on the two largest arrival days since 08-26, in a series where the median's rank correlation with newcomer share is 0.72**, so the reading is positional and arrivals are its leading account. The five-day venue-share mean is back at the pre-dip level (0.2 SE), a move one swapped day accounts for, and still 10.6 counting SE below the platform bound. Backlog #25–#29 (Sep 7–11): **the level question moved off single days** after three single-day partitions reversed each other, and was read on the trailing mean against the pre-dip level and the pre-dip decline's line, which it left by 2.4–3.2 SE; the NN newcomer cell was positive on five of #24–#29 and its 126-query bar was retired. Along the way `below_platform_run` switched from enumerating 3.6 billion arrangements to an exact count, the moderation and withdrawal checks were scoped to the cutoff, and #24's unpublished union cell was restated. **All 14 edits in #25's 5.8-day feed-lag window were platform substitutions — 23 across twenty audited issues, none an author revising prose.** | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) · [#14](results/weather/2026-08-27/report.md) · [#15](results/weather/2026-08-28/report.md) · [#16](results/weather/2026-08-29/report.md) · [#17](results/weather/2026-08-30/report.md) · [#18](results/weather/2026-08-31/report.md) · [#19](results/weather/2026-09-01/report.md) · [#20](results/weather/2026-09-02/report.md) · [#21](results/weather/2026-09-03/report.md) · [#22](results/weather/2026-09-04/report.md) · [#23](results/weather/2026-09-05/report.md) · [#24](results/weather/2026-09-06/report.md) · [#25](results/weather/2026-09-07/report.md) · [#26](results/weather/2026-09-08/report.md) · [#27](results/weather/2026-09-09/report.md) · [#28](results/weather/2026-09-10/report.md) · [#29](results/weather/2026-09-11/report.md) · [#30](results/weather/2026-09-12/report.md) |
...
(2026-09-13 03:07 UTC): **5,106 threads; the latest issue,
[`results/weather/2026-09-12`](results/weather/2026-09-12/report.md), uses a hard cutoff of
2026-09-13 00:00 UTC (61,846 items in scope, 1,643 authors, Aug 5 → Sep 12, excluding 437
