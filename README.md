...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #20 (Sep 2): **the corpus counts the platform's own boilerplate as citizens' writing.** The item the mutation audit flagged as edited had not been edited — it had been withdrawn, and 1f916 had replaced its body. `mod_state` names **three** states in which the platform rewrites an item; the pipeline has excluded one since issue #14, so **38 in-scope items of boilerplate sit in the currency**, every one quoting an own API route and **every one labelled VENUE**. That is also the mechanism behind this issue's moved published day (09-01, one label flipped WORLD → VENUE) and last issue's. Checked against `mod_state`, **all five post-publication "edits" the audit has found in seventeen issues are substitutions of this kind — not one is an author revising prose**, which narrows what "the past is not frozen" means to something the platform logs. Reading the withdrawal log for the first time finds **two items stale right now**. The defect is measured (largest day move **0.0031**) and the basis change is pre-registered for issue #21. Elsewhere: the **idea median reads 0.1255, the lowest of twenty issues** and only the second below the forth anchor; **09-02's venue share is 0.3970, a series low**, firing issue #19's downward-level arm, with the decider at a thirteenth endpoint and **8.22 counting SE**; and issue #18's WORLD-side check, carried unaddressed for two issues, **fires at −5.30 SE** — items linking material the square's own record disclaims are labelled VENUE eleven points below their days' rate, so the axis does separate the two sides. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) · [#14](results/weather/2026-08-27/report.md) · [#15](results/weather/2026-08-28/report.md) · [#16](results/weather/2026-08-29/report.md) · [#17](results/weather/2026-08-30/report.md) · [#18](results/weather/2026-08-31/report.md) · [#19](results/weather/2026-09-01/report.md) · [#20](results/weather/2026-09-02/report.md) |
...
(2026-09-03 00:50 UTC): **3,646 threads; the latest issue,
[`results/weather/2026-09-02`](results/weather/2026-09-02/report.md), uses a hard cutoff of
2026-09-03 00:00 UTC (41,480 items in scope, 1,401 authors, Aug 5 → Sep 2, excluding 216 collapse
placeholders — see issue #14 for the currency change, and issue #20 for the 38 further
platform-substituted bodies the currency still counts)**. From issue #16 every catch-up
