...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #17 (Aug 30): **the idea level fell onto the anchor, and the series stops leading on its own decider.** The window-level median — the cell promoted at #15 — fell **0.0056** to **0.1272**, the largest single-issue *fall* on record (issue #6's +0.0071 is a larger move), second-lowest level ever, and **0.2% above the forth anchor**. The demoted sub-forth rate spiked to 46.2% with Fisher p = 0.0061, and the demotion earns its keep: holding the level fixed that rate reads **7.7%**, so it is the level's shadow, not a second finding. **Issue #8's decider fires a tenth consecutive time at 5.91 counting SE, the deepest yet — and this issue stops presenting it as a finding about the square.** New this week, [`results/venue_conflation`](results/venue_conflation/README.md) scores 2,160 items from each venue under one predicate with three outcomes and no default clause: 1f916 **0.693** venue against lemmy.world's **0.417**, so the level's sign against the comparator **inverts** (published −0.042, symmetric **+0.277**); lemmy carries 3.6x the subjectless content; and the axis separates its own buckets by about **eight points**. The rule is still computed and printed — that is what a pre-registration is for — but not read as self-attention, and explicitly **not** as collapse: a subject axis cannot separate a venue recycling its own text from one whose surface is expanding into checkable reality, which is what a token, a witness file and an append-only event log are. Elsewhere the issue is quiet and clean: **all three newcomer cells went dark** at 16 newcomer items and the pooled fallback fired exactly as #16 pre-registered, reading parity 1.052 / union 1.042 / NN Δ 0.0114 on 529 items; the **shared-prefix assertion returns and holds at 0 of 837**; arrivals fell a sixth day to **11**; the pre-event panel bounced to 87, so 08-29's 77 was not a step; 08-27's placement 'step' resolves as an oscillation in a 1.15–1.21 band; moderation flat, id scan clean, no published day moved. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) · [#14](results/weather/2026-08-27/report.md) · [#15](results/weather/2026-08-28/report.md) · [#16](results/weather/2026-08-29/report.md) · [#17](results/weather/2026-08-30/report.md) |
...
(2026-08-31 08:19 UTC): **3,276 threads; the latest issue,
[`results/weather/2026-08-30`](results/weather/2026-08-30/report.md), uses a hard cutoff of
2026-08-31 00:00 UTC (35,653 items in scope, 1,365 authors, Aug 5 → Aug 30, excluding 206
