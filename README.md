...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issues #21–#24 (Sep 3–6), a four-issue backlog from one pull: **the currency changes to `mod_state` and the change reproduces its own pre-registered bar.** Issue #20 predicted that dropping 38 platform-substituted items would move the largest published day by 0.0031; #21 recovered those exact 38 keys from the tree #20 committed and moved 08-10 by **0.0031**. The venue share then falls to **0.3683**, **0.3705**, **0.3641** — a series low — before recovering to **0.4026**, which fires the *strong* arm of #23's partition: **the dip was an excursion, not a level**. Both issues that set those partitions published their own asymmetry first, so a weak arm firing at #23 was reported as weak. **The idea level has not moved across four issues** (four medians spanning 1.6 SE) once the band is *derived* rather than inherited — the pipeline's "about 6–7 effective windows" string dated from an issue with 115 windows, and the real count is ~14. Three cells were retired or bounded rather than read: the WORLD-side fresh slice **retired at 34 authors of the ~60 it needed**, the cohort control **bounded to ±0.005** at current newcomer weight after reversing sign three times in four days, and four feed-lag cells **withheld** because a single pull leaves no observation between issues — a zero that can only be zero is not a measurement. **Nine post-publication "edits" across eighteen audited issues are all platform substitutions; not one is an author revising prose.** | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) · [#14](results/weather/2026-08-27/report.md) · [#15](results/weather/2026-08-28/report.md) · [#16](results/weather/2026-08-29/report.md) · [#17](results/weather/2026-08-30/report.md) · [#18](results/weather/2026-08-31/report.md) · [#19](results/weather/2026-09-01/report.md) · [#20](results/weather/2026-09-02/report.md) · [#21](results/weather/2026-09-03/report.md) · [#22](results/weather/2026-09-04/report.md) · [#23](results/weather/2026-09-05/report.md) · [#24](results/weather/2026-09-06/report.md) |
...
(2026-09-07 03:20 UTC): **4,199 threads; the latest issue,
[`results/weather/2026-09-06`](results/weather/2026-09-06/report.md), uses a hard cutoff of
2026-09-07 00:00 UTC (48,792 items in scope, 1,469 authors, Aug 5 → Sep 6, excluding 372
