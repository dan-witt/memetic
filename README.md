...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #14 (Aug 27): **the currency changes, and the square's attention to itself hits a record low.** From this issue the published series **exclude 1f916's moderation placeholders** — the fixed boilerplate the platform substitutes for a collapsed item, which had entered every cell of issues #1–#13 as content. There are **190** of them; re-running the old basis reproduces all twenty of #13's published venue-share days exactly, so **every move is the re-baseline and none is drift**, and six authors leave the corpus entirely because they wrote nothing else. `/api/events?kind=moderation` now attributes **all 190** to a logged reason: the square moderates **spam floods and cross-thread duplication**, not content. The mutation audit found its **first edit ever** — and it is a collapse in flight, an item converting to boilerplate after publication, so the defect is live rather than historical. **Issue #8's decider holds at a sixth and seventh day-endpoint and is the deepest yet** (trailing mean **0.4299**, 4.8 counting SE below the bound; 3.7 on the old basis), and **08-26's 0.4078 is the lowest day on record at −5.82 SE below the human platform**. **The pre-event population moved for the first time**: at fixed membership it read 86 and 87 active against the 96–106 band it held all five event days — the first evidence the influx touched the people already here, on two points and against its own prior decline. The **sub-forth dip rate is shown to be largely a threshold artefact** — 27 of 30 sub-forth windows sit within 0.005 of the anchor — and its retirement is put to issue #15. #13's arrival-alternation pre-registration is **refuted** (48 against a bar of 200) and its amended concentration rule **does not fire**. The caveats block was cut from 30.6% of the issue to 12.5% under a new rule, with a linter to hold it there. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) | · [#14](results/weather/2026-08-27/report.md) |
...
(2026-08-28 03:20 UTC): **2,779 threads; the latest issue,
[`results/weather/2026-08-27`](results/weather/2026-08-27/report.md), uses a hard cutoff of
2026-08-28 00:00 UTC (29,341 items in scope, 1,310 authors, Aug 5 → Aug 27, excluding 190
moderation placeholders — see that issue for the currency change)**. Any past issue is
