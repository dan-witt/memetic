...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issue #19 (Sep 1): **a pre-registered control fires, and it took two tries to read it right.** Issue #18 demoted issue #17's pooled newcomer point on a parity inversion (1.052 → 0.952) and pre-registered an m-matched control in case the move was really the draw size. At the registered m = 346 over 20 outer draws, issue #18's window reads **0.951**: **the move survives and issue #18's reading stands.** This issue's own first version of the control drew the subsample once and reported the opposite (1.021); that never shipped, and the control now repeats every cell over its outer draws and marks the rows that cannot vary. Both pre-registered retire branches fire, so **the pooled newcomer cell is retired** — the three windows share two thirds of their items but only a third of their newcomer *sets* (188 of issue #17's 529 newcomer items switch sides, 144 leave the window), so consecutive points are at once too dependent to be independent evidence and too different to be one series. Elsewhere a maintenance day made legible: **two post-publication edits, the most of any issue**, traced end to end — they moved six rolling windows in two runs of three (none crossing the anchor) and flipped one 08-27 label from WORLD to VENUE, which is the whole of that published day's +0.0005 move, the first single-item attribution the series has made. Issue #18's pre-registered spread cell also lands: the within-issue SD is **flat at 0.0063** across the four issues whose medians moved most, so those were level moves, not a noisier cell. The idea median fell **−0.0038 to 0.1288**; the decider fires a twelfth time at **6.99 counting SE**; 09-01's venue share reads **0.4122**, landing in a 0.010-wide gap issue #18's two bars left open — re-specified with no gap. Ten moderation events, zero content actions: a front-page sweep, a new canonical pin and one self-reversal, which is three incidents to ten events and the first case that separates the units. | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) · [#14](results/weather/2026-08-27/report.md) · [#15](results/weather/2026-08-28/report.md) · [#16](results/weather/2026-08-29/report.md) · [#17](results/weather/2026-08-30/report.md) · [#18](results/weather/2026-08-31/report.md) · [#19](results/weather/2026-09-01/report.md) |
...
(2026-09-02 00:54 UTC): **3,497 threads; the latest issue,
[`results/weather/2026-09-01`](results/weather/2026-09-01/report.md), uses a hard cutoff of
2026-09-02 00:00 UTC (39,472 items in scope, 1,392 authors, Aug 5 → Sep 1, excluding 206
