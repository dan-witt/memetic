...
| How is the square trending, issue over issue? | **Weather report** (recurring): band placement, rolling idea series, register trend, churn signatures, cohort survival, inflows, newcomer refresh, **allocation trend**, feed lag, label-coverage audit, **and the matched human-platform level** | Issues #25–#29 (Sep 7–11), a five-issue backlog from one pull: **the level question moves off single days.** 09-07 fired the lower arm of #24's partition and undid its provisional excursion reading, the second single-day partition in a row to reverse the reading before it; from #25 the headline reports the trailing five-day mean's depth in SE and the level is read on the mean. Against the pre-dip level and the pre-dip decline's own fitted line, the mean first matched the decline (#26), then sat between the two (#27), then moved **2.4–3.2 SE above the line and within about one SE of the pre-dip level** (#28–#29) — while staying **12 counting SE below the platform bound**, since the pre-dip level was itself below it. **The NN newcomer cell is positive on five of the six issues #24–#29**, and its 126-query bar was retired after a positive at 100. 09-11 reads higher on idea diversity, placement and register at once, which is one day seen by two instruments. Along the way: `below_platform_run` now counts arrangements exactly instead of enumerating 3.6 billion; the moderation and withdrawal checks were scoped to the cutoff; #24's computed-but-unpublished union cell was restated. **All 14 edits in the 5.8-day feed-lag window are platform substitutions — 23 across nineteen audited issues, none an author revising prose.** | [#1](results/weather/2026-08-11/report.md) · [#2](results/weather/2026-08-12/report.md) · [#3](results/weather/2026-08-13/report.md) · [#4](results/weather/2026-08-14/report.md) · [#5](results/weather/2026-08-17/report.md) · [#6](results/weather/2026-08-18/report.md) · [#7](results/weather/2026-08-19/report.md) · [#8](results/weather/2026-08-20/report.md) · [#9](results/weather/2026-08-21/report.md) · [#10](results/weather/2026-08-22/report.md) · [#11](results/weather/2026-08-23/report.md) · [#12](results/weather/2026-08-24/report.md) · [#13](results/weather/2026-08-25/report.md) · [#14](results/weather/2026-08-27/report.md) · [#15](results/weather/2026-08-28/report.md) · [#16](results/weather/2026-08-29/report.md) · [#17](results/weather/2026-08-30/report.md) · [#18](results/weather/2026-08-31/report.md) · [#19](results/weather/2026-09-01/report.md) · [#20](results/weather/2026-09-02/report.md) · [#21](results/weather/2026-09-03/report.md) · [#22](results/weather/2026-09-04/report.md) · [#23](results/weather/2026-09-05/report.md) · [#24](results/weather/2026-09-06/report.md) · [#25](results/weather/2026-09-07/report.md) · [#26](results/weather/2026-09-08/report.md) · [#27](results/weather/2026-09-09/report.md) · [#28](results/weather/2026-09-10/report.md) · [#29](results/weather/2026-09-11/report.md) |
...
(2026-09-12 22:57 UTC): **5,062 threads; the latest issue,
[`results/weather/2026-09-11`](results/weather/2026-09-11/report.md), uses a hard cutoff of
2026-09-12 00:00 UTC (59,588 items in scope, 1,595 authors, Aug 5 → Sep 11, excluding 432
platform-substituted bodies — see issue #14 for the first currency change and issue #21 for the
move to `mod_state`, which excludes all three states in which the platform rewrites an item).
From issue #21 each issue also publishes `currency_excluded_keys`, the exact set its currency
drops, so an issue reproduces itself even after later moderation changes what the live archive
would derive.** From issue #16 every catch-up
runs an **id-contiguity scan** (`corpus_store.id_gaps`) and repairs what it finds, so the corpus
holds every in-scope id the API still serves. Any past issue is
